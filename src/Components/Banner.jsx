...
const Banner = () => {
    return (
        <div className="bg-cover bg-no-repeat rounded-3xl md:w-full h-full md:h-[35.5rem] mb-10"style={
            {backgroundImage:'url(https://i.ibb.co.com/hYK8bN6/Rectangle-1.png)'}
        }>
...
<button className="text-white btn btn-outline hover:bg-green-400 rounded-full">Our Feedback</button>
</div>
</div>
        </div>
    );
